...
public final class PlayerPositionMessageHandler implements ServerMessageHandler<PlayerPositionMessage> {
	@Override
	public void handle(Session session, PlayerPositionMessage message) {
