...
<<<<<<< HEAD:src/main/java/org/spout/vanilla/protocol/codec/PlayEffectCodec.java
		return new PlayEffectMessage(id, x, y, z, data, volumeDecrease);
=======
		return new EffectMessage(id, x, y, z, data, volumeDecrease);
>>>>>>> 43c4837603f8d11e79b43629e6d211aac83e5e42:src/main/java/org/spout/vanilla/protocol/codec/world/EffectCodec.java
	}
