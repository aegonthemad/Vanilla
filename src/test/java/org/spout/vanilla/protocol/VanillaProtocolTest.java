...
<<<<<<< HEAD
			...
			new TimeUpdateMessage(666L, 666L),
=======
...
<<<<<<< HEAD
			...
			new ClientSettingsMessage("en_GB", ClientSettingsMessage.VIEW_NORMAL, (byte) 0, (byte) 0, false),
			...
			new EntitySpawnItemMessage(1234, null, 1, 2, 3, 34, 56, 55),
...
<<<<<<< HEAD
			new PlayEffectMessage(34566, 1, 2, 34, 5, false),
			...
			new WindowClickMessage(1, 2, false, 34, true, null),
